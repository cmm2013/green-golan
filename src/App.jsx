          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "4px 0" }}>
                ...
                <span style={{ fontSize: 12, color: "#999" }}>או</span>
                <div style={{ flex: 1, height: 1, background: "rgba(0,0,0,0.1)" }} />
              </div>
              <button onClick={() => db.auth.signInWithOAuth({ provider: "google", options: { redirectTo: window.location.origin } })} style={{
                background: "#fff", border: "1.5px solid #ddd", borderRadius: 50,
                padding: "12px 20px", fontSize: 14, fontWeight: 700, cursor: "pointer",
                display: "flex", alignItems: "center", justifyContent: "center", gap: 10,
                color: "#333", fontFamily: "inherit", width: "100%",
